...
public class QuitConfirmPopupActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quit_confirm_popup);

        btn_close_yes = (Button) findViewById(R.id.btn_quit_popup_close_yes);
        btn_close_no = (Button) findViewById(R.id.btn_quit_popup_close_no);
