...
public class LevelManager {
    ...
    public LevelManager() {
        ...
        level_5.disableTile(1,1);
        level_5.disableTile(5,1);
        level_5.disableTile(1,4);
        level_5.disableTile(5,4);
        level_5.setDefaultGate(2,2,"NOT");
        level_5.setAvailableGates(2,2,new String[] {"NOT","AND","NULL"});
        level_5.setDefaultGate(3,3,"AND");
        level_5.setAvailableGates(3,3,new String[] {"AND"});
