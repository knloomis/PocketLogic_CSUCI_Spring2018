...
public class TileManager{
    ...
    public TileManager(Activity activity){
        ...
        tileLibrary = new Tile [25];        //Init tile array
    ...
    private void loadLibrary(){
        ...
        tileLibrary[5] = new Tile ((ImageView) this.activity.findViewById(R.id.tile_21));
        tileLibrary[6] = new Tile ((ImageView) this.activity.findViewById(R.id.tile_31));
        tileLibrary[7] = new Tile ((ImageView) this.activity.findViewById(R.id.tile_41));
        tileLibrary[8] = new Tile ((ImageView) this.activity.findViewById(R.id.tile_51));
        tileLibrary[9] = new Tile ((ImageView) this.activity.findViewById(R.id.tile_12));
        tileLibrary[10] = new Tile ((ImageView) this.activity.findViewById(R.id.tile_22));
        tileLibrary[11] = new Tile ((ImageView) this.activity.findViewById(R.id.tile_32));
        tileLibrary[12] = new Tile ((ImageView) this.activity.findViewById(R.id.tile_42));
        tileLibrary[13] = new Tile ((ImageView) this.activity.findViewById(R.id.tile_52));
        tileLibrary[14] = new Tile ((ImageView) this.activity.findViewById(R.id.tile_13));
        tileLibrary[15] = new Tile ((ImageView) this.activity.findViewById(R.id.tile_23));
        tileLibrary[16] = new Tile ((ImageView) this.activity.findViewById(R.id.tile_33));
        tileLibrary[17] = new Tile ((ImageView) this.activity.findViewById(R.id.tile_43));
        tileLibrary[18] = new Tile ((ImageView) this.activity.findViewById(R.id.tile_53));
        tileLibrary[19] = new Tile ((ImageView) this.activity.findViewById(R.id.tile_14));
        tileLibrary[20] = new Tile ((ImageView) this.activity.findViewById(R.id.tile_24));
        tileLibrary[21] = new Tile ((ImageView) this.activity.findViewById(R.id.tile_34));
        tileLibrary[22] = new Tile ((ImageView) this.activity.findViewById(R.id.tile_44));
        tileLibrary[23] = new Tile ((ImageView) this.activity.findViewById(R.id.tile_54));
        tileLibrary[24] = new Tile ((ImageView) this.activity.findViewById(R.id.light_1));
    }

    private void loadCoordinates(){
        //Switches XY
        tileLibrary[0].setXY(new int [] {300,140});
        tileLibrary[1].setXY(new int [] {580,140});
        tileLibrary[2].setXY(new int [] {860,140});
        tileLibrary[3].setXY(new int [] {1140,140});

        //Tile_11 - Tile_51 XY
        tileLibrary[4].setXY(new int [] {165,380});
        tileLibrary[5].setXY(new int [] {445,400});
        tileLibrary[6].setXY(new int [] {725,365});
        tileLibrary[7].setXY(new int [] {1005,365});
        tileLibrary[8].setXY(new int [] {1285,365});

        //Tile_12 - Tile_52 XY
        tileLibrary[9].setXY(new int [] {165,800});
        tileLibrary[10].setXY(new int [] {445,800});
        tileLibrary[11].setXY(new int [] {725,800});
        tileLibrary[12].setXY(new int [] {1005,800});
        tileLibrary[13].setXY(new int [] {1285,800});

        //Tile_13 - Tile_53 XY
        tileLibrary[14].setXY(new int [] {165,1230});
        tileLibrary[15].setXY(new int [] {445,1230});
        tileLibrary[16].setXY(new int [] {725,1230});
        tileLibrary[17].setXY(new int [] {1005,1230});
        tileLibrary[18].setXY(new int [] {1285,1230});

        //Tile_14 - Tile_54 XY
        tileLibrary[19].setXY(new int [] {165,1665});
        tileLibrary[20].setXY(new int [] {445,1665});
        tileLibrary[21].setXY(new int [] {725,1665});
        tileLibrary[22].setXY(new int [] {1005,1665});
        tileLibrary[23].setXY(new int [] {1285,1665});

        //light_1 XY
        tileLibrary[24].setXY(new int [] {735,2435});
